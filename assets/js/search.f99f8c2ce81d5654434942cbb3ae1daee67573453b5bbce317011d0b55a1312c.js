...
(() => {
  ...
  (t.onkeyup = function () {
    if (i) {
      const e = i.search(this.value.trim());
      if (e.length !== 0) {
        let t = "";
        for (let n in e)
    ...
    (document.onkeydown = function (e) {
      ...
      let h = document.getElementById("searchbox").contains(i);
      if (i === t)
        ...
        d === "ArrowDown"
          ? (e.preventDefault(),
            i == t
              ...
              : i.parentElement != c &&
                o(i.parentElement.nextSibling.lastChild))
          : d === "ArrowUp"
            ? (e.preventDefault(),
              i.parentElement == r
                ? o(t)
                : i != t && o(i.parentElement.previousSibling.lastChild))
            : d === "ArrowRight" && i.click();
    });
})();
